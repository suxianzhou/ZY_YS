...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(refreshAllDataWhenLoginUserChange:) name:kUMComGetTokenSucceedNotification object:nil];
...
//    [self.view addSubview:recommendPostListController.view];
    //添加置顶类---begin
...
//    recommendPostListController.view.center = CGPointMake(commonFrame.size.width * 3 / 2, centerY);
    ...
    UMComSearchBar * topicsSearchBar = [self createSearchBarWithPlaceholder:UMComLocalizedString(@"um_com_searchTopic", @"搜索话题")];
